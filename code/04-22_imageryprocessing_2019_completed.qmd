...
```{r}
rastlist <- list.files(path = "../data/classcotton-PSScene-ortho_analytic_4b_sr-2019-105-2019-273/",
...
```{r}
pixels_f <- pixels %>%
  filter(!date %in% as.Date(c("2019-06-15", "2019-09-28")))
...
```{r}
pixel_median %>%
  write_sf("../data/2019_pixel_median.geojson",
           delete_dsn = T
           )
